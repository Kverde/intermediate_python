...
Подробнее пользовательские типы описаны в главе про объектное ориентированное программирование.
...
Генераторы создаются при вызове функций генераторов (функции использующие клучевое слово `yield`). Этот тип обсуждается детальнее в главе Последовательности и генераторы.

После знакомства с иерархией встроенных типов, пришло время изучить глубже объектное ориентированное программирование и способы создания своих иерархий и даже классов похожих похожих поведением на встроенные типы.
